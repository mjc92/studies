...
- Graves et al. [[paper]](https://arxiv.org/pdf/1410.5401v2.pdf) 


* Motivation: 
  - Enrich the capabilities of RNNs to simplify the solution of algorithmic tasks
* Contribution: 
  1. A memory architecture and attentional controller that performs in tasks of induction and execution of programs
* Method: 
* Results: 
* Future work: 
...
- Basics
  ...
  - Memory bank
  - every component is differentiable (gradient descent appliable)
  - uses "focus" mechanism that constrains each read and write operation to parts of memory
- Addressing mechanisms
  - content-based addressing : focuses on locations based on similarity between current values and values emitted by the controller
    - compare cosine similarity
  - location-based addressing : for arithmetic operations (ex. x * y)
    - rotational shift of weighting
      - if currently pointing 
